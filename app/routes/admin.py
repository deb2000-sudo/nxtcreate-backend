...
from app.models.video_model import VideoSessionResponse
from app.routes.video import _build_session_response
...
@router.get("/user/{user_id}/videos", status_code=200)
async def get_user_videos(
    user_id: str,
    admin: CurrentUser = Depends(get_admin_user),
) -> list[VideoSessionResponse]:
    """
    Get all video sessions generated by a specific user.
    ...
    Returns:
        List of the user's video sessions, newest first
    """
    try:
        ...
        sessions = video_service.list_user_sessions(user_id)
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Error retrieving user videos",
        )
